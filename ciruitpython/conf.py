...
# When called the keypress will pass each keypress in order, so make sure modifier keys like `ctrl` or `shift`
# are sent before the main key, such as `z` otherwise the program will process the z before the shift is called
mode_1 = {
    ...
    "btn11": ["M", [Keycode.M]],
    "btn12": ["F", [Keycode.F]],
    "btn13": ["Undo", [Keycode.LEFT_CONTROL, Keycode.Z]],
